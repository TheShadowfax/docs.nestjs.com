...
If you are using the [Nest CLI](https://docs.nestjs.com/cli/overview), the configuration process is pretty straighforward. The CLI wraps `webpack`, which allows use the `HotModuleReplacementPlugin`.
